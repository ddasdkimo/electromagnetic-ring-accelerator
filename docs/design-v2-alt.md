...
**stl 定案（2026-07-28）：線圈區局部加厚 +3，法蘭槽開在加厚墊內**——即 `test_v2_tunnel` 的組合做法。
理由是 3mm 底板直接開 1.93 + 餘裕的沉槽後只剩約 0.7mm 膜，懸空區易翹易破；
加厚墊能全實心列印，並順帶給集中驅動板提供鎖點。
...
| 法蘭座 | 法蘭下緣落在 −1.93mm → **線圈區局部加厚 +3，法蘭槽開在加厚墊內** | 3mm 底板直開沉槽只剩 0.7mm 膜，易翹易破 |
